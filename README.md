...
Tech Stack: Angular.js, React.js, Vue.js, Knockout.js, Backbone.js, d3.js, ES6, Handlebars, Haml, Jade, jQuery, Pebble.js, YUI, Node.js, Phantom.js, Underscore, Bootstrap, Material Design, Semnatic UI, JSON, XML, HTML5, CSS3, APIs, AJAX, Socket.IO, PHP, JSP, XSS, Spring, Struts, XSLT, Java, Rails, RequireJS, Webpack, Grunt, Gulp, Bower, Jenkins, MongoDB, mySQL, responsive design, Maven, Karma, Jasmin, Git, Git Gerrit, Docker.
